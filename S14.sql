...
Create Table ALUMNO(
     ...
     Delegado     VARCHAR2(5) Not Null,
     Edad         Int Not Null,
     Estado       Varchar2(20) Not Null,
     CONSTRAINT PK_CODIGO_ALUMNO PRIMARY KEY (Cod_Alu),
     CONSTRAINT RELACION_DELEGADO FOREIGN KEY (Delegado) REFERENCES ALUMNO(Cod_Alu),
...
CREATE TABLE TRABAJADOR ( 
    ...
    CONSTRAINT LLAVE_TRABAJADOR PRIMARY KEY (COD_TRA),
    CONSTRAINT RELACION_JEFE FOREIGN KEY (JEFE) REFERENCES TRABAJADOR(COD_TRA)
);
...
INSERT INTO TRABAJADOR VALUES ('00001','DE LA MADRID','GUTIERREZ' , 'MARICIELO', '01/11/1980',980,'F','CONTABILIDAD','00001');
INSERT INTO TRABAJADOR VALUES ('00002','HURTADO','CORONEL', 'NILDA', '10/10/1976',980.50,'F','CONTABILIDAD','00001');
INSERT INTO TRABAJADOR VALUES ('00003','PAREDES','MARTINEZ','EDITH', '10/10/1976',1500.50,'F','SISTEMAS','00001');
INSERT INTO TRABAJADOR VALUES ('00004','CARDOSO','VALLADARES','HENRY', '10/10/1980',1200.5,'M','SISTEMAS','00001');
INSERT INTO TRABAJADOR VALUES ('00005','UBILLUS','MARQUEZ','MIGUEL ANGEL', '05/01/1976',980.60,'M','CONTABILIDAD','00001');
INSERT INTO TRABAJADOR VALUES ('00006','LIZARRAGA','DEL OLMO','NUPCIA MASSIEL','05/10/1980',1300.70,'F','SISTEMAS','00001');
INSERT INTO TRABAJADOR VALUES ('00007','AGUIRRE','RIVADENEIRA','VANNIA', '05/10/1975',1200.10,'F','SISTEMAS','00001');
INSERT INTO TRABAJADOR VALUES ('00008','JUAREZ','LAZO','GINO','05/10/1969',1200.30,'M','LOGISTICA','00001');
INSERT INTO TRABAJADOR VALUES ('00009','PINTADO','ROBLES','JUAN ABEL', '28/08/1984',1000.50,'M','LOGISTICA','00001');
INSERT INTO TRABAJADOR VALUES ('00010','BARRANTES','MEDINA','LUIS ALBERTO','28/08/1975',1000.90,'M','LOGISTICA','00001');
INSERT INTO TRABAJADOR VALUES ('00011','CAMPOS','GAMBO' , 'SONIA', '02/11/1980',NULL,'F','CONTABILIDAD','00002');
INSERT INTO TRABAJADOR VALUES ('00012','HURTADO','SANCHEZ', 'SUSANA', '12/11/1976',980.50,'F','CONTABILIDAD','00002');
INSERT INTO TRABAJADOR VALUES ('00013','CANTUR','GOMEZ','ELIZABETH', '12/10/1976',NULL,'F','SISTEMAS','00002');
INSERT INTO TRABAJADOR VALUES ('00014','SALAS','CARPIO','ROBERT', '16/12/1982',1200.5,'M','SISTEMAS','00002');
INSERT INTO TRABAJADOR VALUES ('00015','UBILLUS','CAMPOS','MIGUEL', '15/04/1976',NULL,'M','CONTABILIDAD','00002');
INSERT INTO TRABAJADOR VALUES ('00016','SANCHEZ','DE LA CRUZ','LORENA','05/10/1980',1800.70,'F','SISTEMAS','00002');
INSERT INTO TRABAJADOR VALUES ('00017','GUTIERREZ','NAVARRO','CECILIA', '15/11/1979',NULL,'F','SISTEMAS','00002');
INSERT INTO TRABAJADOR VALUES ('00018','JUAREZ','SANTOS','MAGNO','15/12/1969',1600.50,'M','LOGISTICA','00002');
INSERT INTO TRABAJADOR VALUES ('00019','OROPEZA','ESTRADA','CARLOSL', '28/09/1985',NULL,'M','LOGISTICA','00002');
INSERT INTO TRABAJADOR VALUES ('00020','ESTRADA','CAMPOS','JUAN JOSE','18/05/1979',NULL,'M','LOGISTICA','00002');
COMMIT;
...
Insert Into ALUMNO Values ('A0001', 'PEREZ SANCHEZ JUAN','Masculino', 1,'22/07/2000', 'A0001', 19, 'ACTIVO');
Insert Into ALUMNO Values ('A0002', 'SARMIENTO CESPEDES CARMEN','Femenino', 1,'20/08/2005','A0001', 15, 'ACTIVO');
Insert Into ALUMNO Values ('A0003', 'ALCANTARA VARGAS CARLOS','Masculino', 2,'05/06/2004','A0001', 16, 'ACTIVO');
Insert Into ALUMNO Values ('A0004', 'SANCHEZ CAMPOS LUIS','Masculino', 1,'10/04/2000', 'A0001', 19, 'ACTIVO');
Insert Into ALUMNO Values ('A0005', 'VALDIVIA SALCEDO ELIZABETH','Femenino', 1,'05/04/2005', 'A0001', 15, 'ACTIVO');
Insert Into ALUMNO Values ('A0006', 'ESPINOZA VARGAS CELINA','Femenino', 2,'22/03/2004', 'A0002',16, 'ACTIVO');
Insert Into ALUMNO Values ('A0007', 'CAMPOS FLORES EDUARDO','Masculino', 3,'02/06/1999','A0002', 20, 'ACTIVO');
Insert Into ALUMNO Values ('A0008', 'NAVARRO RODRIGUEZ CELESTE','Femenino', 3,'10/02/2000','A0002', 19, 'ACTIVO');
Insert Into ALUMNO Values ('A0009', 'RAMIREZ OCHOA ALEJANDRA','Femenino', 2,'01/03/2002','A0002', 17, 'ACTIVO');
Insert Into ALUMNO Values ('A0010', 'SALAS FERNANDEZ JULIAN','Masculino', 2,'05/03/2002','A0002', 17, 'ACTIVO');
COMMIT;
...
-- DESDE AQUI EMPIECE LA SOLUCION DEL EXAMEN FINAL
